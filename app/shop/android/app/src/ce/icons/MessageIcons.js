...
export default function MessageIcons({ color, size }) {
  return (
    <>
      <svg fill={color} width={size} height={size} viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" stroke="#FF4500">
