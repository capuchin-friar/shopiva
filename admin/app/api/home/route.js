...
export async function GET() {
  try {
    ...
    const activeRes = await pool.query(`SELECT COUNT(*)::int AS active FROM users WHERE accountstatus = 'active' OR COALESCE((status::jsonb)->'deleted'->>'enabled','false') = 'false'`);
