    ...
    <>
        <div className="product_summary_cnt">
            ...
            <div className="product_summary_list">
                {
                    data.map((product, ind) => <ProductCard index={ind} product_price={product.price} product_thumbnail={product.thumbnail} product_title={product.title} product_stock={product.stock} />)
                }
            </div>
        </div>
    </>
